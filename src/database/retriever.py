...
=============================================
Combines Qdrant semantic search (dense + native BM25) with Neo4j
...
--------
  User Query
    ...
    ├─→ [2] Qdrant native BM25    (lexical keyword match)
...
class HybridRetriever:
    """Hybrid retrieval combining dense semantic search, native BM25
    ...
    async def retrieve(
        ...
        sparse_weight : float
            Weight for the native BM25 channel in RRF fusion.
        rrf_k : int
